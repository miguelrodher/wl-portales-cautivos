...
<div class="container-fluid">
  <div class="row">
    ...
    <!-- CONTENIDO: formulario para editar nombre restringido -->
    <main class="col-12 col-md-9 col-lg-10 py-4">
      <div class="container mt-4">

        <h2 class="mb-4 text-center">Editar nombre restringido</h2>

        <form action="{{ route('editarRestriccionNombrePost', $nombre->id) }}" method="POST">
            @csrf

            <div class="mb-3">
                <label class="form-label">Nombre restringido:</label>

                <input 
                    type="text" 
                    name="restriccion" 
                    class="form-control @error('nombre') is-invalid @enderror"
                    value="{{ old('nombre', $nombre->restriccion) }}"
                    required
                >
