...
<div class="container-fluid">
  <div class="row">
    ...
    <!-- CONTENIDO: formulario para agregar telefono restringido -->
          ...
          <div class="col-12 col-md-8 col-lg-6">
            <div class="card shadow-sm">
              <div class="card-header bg-light">
                <h4 class="mb-0">Agregar Restricción de Telefono</h4>
              </div>
                ...
                <form action="{{ route('registroRestriccionTelefonoPost') }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="restriccion" id="restriccion"
                      ...
                      placeholder="Ingrese el nuevo telefono restringido"
