...
<div class="container-fluid">
  <div class="row">
    ...
    <!-- CONTENIDO: formulario para editar telefono restringido -->
    <main class="col-12 col-md-9 col-lg-10 py-4">
      <div class="container mt-4">

        <h2 class="mb-4 text-center">Editar telefono restringido</h2>

        <form action="{{ route('editarRestriccionTelefonoPost', $telefono->id) }}" method="POST">
            @csrf

            <div class="mb-3">
                <label class="form-label">Telefono restringido:</label>

                <input 
                    type="text" 
                    name="restriccion" 
                    class="form-control @error('telefono') is-invalid @enderror"
                    value="{{ old('telefono', $telefono->restriccion) }}"
                    required
                >
